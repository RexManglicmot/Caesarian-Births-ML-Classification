...
* Reduced risk of overfitting. When a single decision tree is made, there is a possibly to fir all the observations in the training data, but with RF, it helps alleviate that since averaging uncorrelated tress decreases both variance and prediction error. 
